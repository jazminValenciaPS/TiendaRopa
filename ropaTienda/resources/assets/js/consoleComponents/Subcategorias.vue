<template>
    <main class="main">
       ...
       <!-- Mostrar subcategoria -->
        ...
        <div class="row">
                <ul class="collection col s12 l12" v-for="subcategoria in arraySubcategoria" :key="subcategoria.idSubCategorias">
    ...
    export default {
        ...
        methods: {
            ...
            validarSubCategoria(){
                ...
                if(!isNaN(this.NombreSub))this.errorMostrarMsjSubcategoria.push("El nombre de la SubCategoría no puede ser numérico.");
